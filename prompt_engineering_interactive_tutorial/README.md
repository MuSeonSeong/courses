...
Note: This tutorial uses our smallest, fastest, and cheapest model, Claude 3 Haiku. Anthropic has [two other models](https://docs.anthropic.com/claude/docs/models-overview), Claude Sonnet 4.6 and Claude Opus 4.6, which are more intelligent than Haiku, with Opus being the most intelligent.
